...
syn keyword gapOperator	and div in mod not or break

syn keyword gapFunction	function -> return local end Error Add Unbind Order Group Size IsAbelian AsList Display Print AddSet Append Length ShallowCopy LeadingCoefficient LeadingTermOfPolynomial 
syn keyword gapConditional	if else elif then fi
syn keyword gapRepeat		do od for while repeat until
syn keyword gapKey         Info IsBound
