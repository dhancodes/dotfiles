...
" must do
syn keyword gapTodo TODO contained FIXME IMPO
...
hi gapString ctermfg=10 guifg=Green
hi gapFunction  cterm=bold ctermfg=6 guifg=Blue
...
hi gapComment  ctermfg=8 guifg=LightBlue
...
hi gapBool cterm=bold ctermfg=9 guifg=Magenta
hi gapChar ctermfg=4 guifg=Yellow
hi gapListDelimiter ctermfg=12 guifg=Gray
